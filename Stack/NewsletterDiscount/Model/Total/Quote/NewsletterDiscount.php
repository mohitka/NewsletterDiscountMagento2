...
namespace Stack\NewsletterDiscount\Model\Total\Quote;
    ...
    \Magento\Quote\Model\Quote\Address\Total\AbstractTotal
{
    ...
    /**
     * @var \Stack\NewsletterDiscount\Model\Service
     */
    protected $service;
    ...
    /**
     * @var \Stack\NewsletterDiscount\Model\Program
     */
    protected $_program;

    public function __construct(
        \Stack\NewsletterDiscount\Helper\Config $helperConfig,
        \Stack\NewsletterDiscount\Model\Service $service,
...
//        die();
        ...
        $amount     = 0;
        if ( $discountOn == \Stack\NewsletterDiscount\Model\Config\Source\DiscountOn::SUBTOTAL ) {
            $amount = $total->getBaseSubtotal();
        }
        if ( $discountOn == \Stack\NewsletterDiscount\Model\Config\Source\DiscountOn::GRANDTOTAL ) {
