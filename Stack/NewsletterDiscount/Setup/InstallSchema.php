...
namespace Stack\NewsletterDiscount\Setup;
    ...
    \Magento\Framework\Setup\InstallSchemaInterface
{
    ...
    public function install(
         ...
         */
        $installer->getConnection()->dropTable($installer->getTable('newsletterdiscount_program'));
        /**
         * Create table 'newsletterdiscount_program'
         */
        $table = $installer->getConnection()
                           ->newTable($installer->getTable('newsletterdiscount_program'))
                           ->addColumn(
