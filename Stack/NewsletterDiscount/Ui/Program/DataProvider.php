...
namespace Stack\NewsletterDiscount\Ui\Program;
    ...
    \Magento\Ui\DataProvider\AbstractDataProvider
{
    ...
    /**
     * @var \Stack\NewsletterDiscount\Model\ResourceModel\Program\Collection
     */
    ...
    public function __construct(
        ...
        $primaryFieldName,
        $requestFieldName,
        \Stack\NewsletterDiscount\Model\ResourceModel\Program\Collection $collection,
        array $meta = [],
        array $data = []
    ) {
